...
bool TextAdventureGame::init()
{
	...
	//Load font
	renderer->setFont(renderer->loadFont("Resources\\UI\\FONT\\font.ttf", 55));
	...
	loading_monitor_background_red.loadSprite(renderer.get(), "Resources\\UI\\LOADSCREEN\\loading_monitor_background_red.png");
	loading_monitor_background_blue.loadSprite(renderer.get(), "Resources\\UI\\LOADSCREEN\\loading_monitor_background_blue.png");
	loading_monitor_background_black.loadSprite(renderer.get(), "Resources\\UI\\LOADSCREEN\\loading_monitor_background_black.png");
